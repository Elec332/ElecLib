...
import nl.elec332.lib.java.util.FileHelper;
...
public class FileChooserHelper {
    ...
    public static FileNameExtensionFilter DEFAULT_FILER = null;
    ...
    public static File openFileProjectChooser(Component parent, File selected, String title) {
        return openFileChooser(parent, DEFAULT_FILER, selected, title);
    }
